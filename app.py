...
st.markdown('<p class="hero-sub">Developer: <strong>Malak Gamal Ahmed Sanad Eleza</strong> &nbsp;·&nbsp; ID: 221000014</p>', unsafe_allow_html=True)
if not model_loaded:
...
if predict_btn:
    ...
    # UI tracking list
    risk_factors = []
    if Sex == 1:          risk_factors.append("Male Demographic Indicator")
